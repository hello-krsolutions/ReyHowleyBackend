...
class InstallController extends Controller
{
    ...
    {
        // Open source version - set placeholder values, no validation needed
        ...
        Session::put('purchase_key', $request['purchase_key'] ?? 'open_source');
        Session::put('username', $request['username'] ?? 'open_source');
