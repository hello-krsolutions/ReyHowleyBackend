                ...
                @if ($language)
                    <div class="lang_form" id="default-form">
                        <h5 class="card-title mb-3">
                            ...
                            <span>{{translate('messages.header_section')}} ({{ translate('messages.default') }})</span>
                        </h5>
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fixed_header_title" type="text" maxlength="50"
                                            ...
                                            value="{{$fixed_header_title?->getRawOriginal('value')}}" class="form-control"
                                            placeholder="{{translate('Ex_:_Manage_your_daily_life_on_one_platform')}}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="fixed_header_sub_title"
                                            class="form-label">{{translate('Sub Title')}}<span class="form-label-secondary"
                        ...
                        <h5 class="card-title mb-3 mt-3">
                            <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                            <span>{{translate('messages.module_list_section')}} ({{ translate('messages.default') }})</span>
                        </h5>
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fixed_module_title" type="text" maxlength="50"
                                            ...
                                            value="{{$fixed_module_title?->getRawOriginal('value')}}" class="form-control"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <label for="fixed_referal_title" class="form-label">{{translate('Title')}}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                        ...
                                        <input id="fixed_referal_title" type="text" maxlength="40"
                                            ...
                                            value="{{$fixed_referal_title?->getRawOriginal('value')}}" class="form-control"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <label for="fixed_newsletter_title" class="form-label">{{translate('Title')}}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Write_the_title_within_40_characters') }}">
                                                <img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="">
                                            </span></label>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input id="fixed_footer_article_title" type="text" maxlength="180"
                                            ...
                                            class="form-control"
                                            placeholder="{{translate('Ex_:_ReyHowley_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_header_title{{$lang}}" type="text" maxlength="50"
                                                        name="fixed_header_title[]"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_header_sub_title{{$lang}}" type="text" maxlength="100"
                                                        name="fixed_header_sub_title[]"
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_module_title{{$lang}}" type="text" maxlength="50"
                                                        name="fixed_module_title[]"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_module_sub_title{{$lang}}" type="text" maxlength="100"
                                                        name="fixed_module_sub_title[]"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_referal_title{{$lang}}" type="text" maxlength="40"
                                                        name="fixed_referal_title[]"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_referal_sub_title{{$lang}}" type="text" maxlength="80"
                                                        name="fixed_referal_sub_title[]"
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_newsletter_title{{$lang}}" type="text" maxlength="40"
                                                        name="fixed_newsletter_title[]"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="fixed_newsletter_sub_title{{$lang}}" type="text" maxlength="80"
                                                        name="fixed_newsletter_sub_title[]"
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="fixed_footer_article_title{{$lang}}" type="text" maxlength="180"
                                                        name="fixed_footer_article_title[]"
                    ...
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <label for="fixed_ref_title" class="form-label">{{translate('Title')}}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Write_the_title_within_50_characters') }}">
                                                <img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="">
                                            </span></label>
                                        <input id="fixed_ref_title" type="text" maxlength="50" name="fixed_referal_title[]"
                                            class="form-control" placeholder="{{translate('Ex_:_Earn_Point')}}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="fixed_ref_sub_title" class="form-label">{{translate('Sub Title')}}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Write_the_sub_title_within_50_characters') }}">
                                                <img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="">
                                            </span></label>
                    ...
                    <div class="__bg-F8F9FC-card">
                        <div class="form-group mb-md-0">
                            ...
                            <input id="web_app_url" type="text"
                                placeholder="{{translate('Ex: https://reyhowley.com/')}}" class="form-control h--45px"
                                name="web_app_url" value="{{ $fixed_link['web_app_url'] ?? ''}}">
                        </div>
                    </div>
                </div>
